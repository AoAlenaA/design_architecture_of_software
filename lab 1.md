...
1. **Сбор данных о результатах тестов**  
   - Приём информации от модуля курсов: пользователь, курс, тема, дата и время, результат, количество ошибок, длительность прохождения.  
   - Сохранение этих данных в аналитической модели.

2. **Сбор данных о сессиях диалогового тренажёра**  
   - Приём данных от модуля Чат-бота: сценарий, длительность, оценки по этапам, типовые ошибки, неотработанные возражения.  
...
1. Модули Курсов и Чат-ботов предоставляют данные в согласованном формате (через REST API или очередь сообщений); идентификаторы пользователей и курсов унифицированы.  
